...
See docs/task3.md for the Mermaid source.
...
Generated by rtm.py from .sdoc files + source code. One row per requirement. Columns: UID, Title, Statement, Status, Parent Need, Code Link.
...
- **Public tunnel URL (Task 3):** A quick tunnel URL is used because the
  ...
  hostname configuration requires dashboard access not available here.
